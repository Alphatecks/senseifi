      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
          <div className="relative w-full max-w-md p-8 rounded-2xl bg-black bg-opacity-60 border border-blue-500 shadow-xl flex flex-col items-center">
            ...
            {/* Error message */}
            {registrationError && (
              <div className="mb-4 p-3 rounded-lg border border-[#F00500]/50 text-sm" style={{ backgroundColor: "rgba(240,5,0,0.2)", color: "#F00500" }}>
                {registrationError}
              </div>
            )}
            ...
            {isConnected && address && (
              <div className="mb-4 p-3 rounded-lg border border-[#32BB1D]/50 text-sm" style={{ backgroundColor: "rgba(50,187,29,0.2)", color: "#32BB1D" }}>
