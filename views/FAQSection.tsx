...
export default function FAQSection() {
  ...
  return (
    ...
    >
      {/* Left Side */}
      <div className="md:w-1/2 w-full px-8 md:px-24 flex flex-col items-start">
      ...
      <div className="md:w-1/2 w-full flex flex-col gap-6 px-8 mt-12 md:mt-0">
        {faqs.map((faq, idx) => (
          <div
            key={faq.question}
            className={`bg-[#0B111E] transition-all duration-200 ${openIndex === idx ? "shadow-lg" : ""} rounded-2xl border border-black relative z-10`}
