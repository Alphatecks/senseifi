...
export default function WhyTrustSection() {
  return (
    <section className="w-full py-24 bg-black text-white flex flex-col items-center">
      <span className="px-6 py-2 rounded-full border border-blue-400 text-blue-300 text-lg font-medium bg-transparent mt-4 mb-2">Why</span>
      ...
      <div className="flex justify-center mt-16">
        <button className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white text-lg rounded-md shadow-lg transition-colors duration-200">
    ...
    <section className="w-full py-24 bg-black text-white flex flex-col items-center">
      ...
      <div className="flex items-center justify-end w-full max-w-6xl mb-8 gap-2">
        ...
        <button className="w-10 h-10 flex items-center justify-center rounded-lg bg-blue-600 text-white"><span className="text-2xl">&#8594;</span></button>
      </div>
      <div className="flex flex-row gap-6 w-full max-w-6xl">
        ...
        <section className="w-full py-24 bg-black text-white flex flex-col items-center">
          ...
          <div className="flex flex-row gap-8 w-full max-w-6xl justify-center">
            {/* PRO PLAN */}
            <div className="bg-[#181C23] rounded-xl flex flex-col min-w-[380px] max-w-[400px] min-h-[600px] w-full shadow-lg">
            ...
            {/* PRO+ PLAN */}
            <div className="bg-[#181C23] rounded-xl flex flex-col min-w-[380px] max-w-[400px] min-h-[600px] w-full shadow-lg border-2 border-blue-600">
                  <div className="flex items-center justify-between mb-0 p-8 pb-0">
